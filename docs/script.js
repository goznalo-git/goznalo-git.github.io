...
class MarkdownLoader {
    constructor() {
        // this.sections = ['about', 'news', 'publications', 'resources', 'resume']; GONZALO -- CHANGE HERE
        this.sections = Array.from(document.querySelectorAll('[id$="-content"]'))
    ...
    async loadMarkdown(section) {
        ...
        for (const fullPath of pathsToTry) {
            try {
                ...
                // const response = await fetch(fullPath); GONZALO -- CHANGE HERE
