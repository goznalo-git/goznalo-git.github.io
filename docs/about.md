...
It's been a while, but I also used to code stuff for fun in my free time. I programmed things such as a markovian guitar tablature generator, or an visualizer of audiowaves/spectrograms since I didn't like the ones I found. 
